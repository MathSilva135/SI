...
public class ClienteService {
    ...
    public ClienteDTO create(ClienteDTO clienteDTO) {
        ...
        try {
            ...
            throw new DataIntegrityException(
                    "Não é possível cadastrar o cliente " +
                            "pois já existe um cliente com número de Inscrção " + cliente.getNumInscricao()
            );
        }
    }
    ...
    public void delete(Long id) {
        ...
        try {
            ...
            throw new DataIntegrityException(
                    "Não é possível excluir o cliente de Inscrição " + cliente.getNumInscricao() + ". " +
                            "Ele tem um ou mais dependentes vinculados ."
            );
        }
    }
